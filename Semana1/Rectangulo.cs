git push -u origin mainnamespace Semana012026B;
...
public class Rectangulo
{
    ...
    {
        return Operaciones.CalcularPerimetro(Punto1, Punto2, Punto3, Punto4);
    }


    public double Area()
    {
        return Operaciones.CalcularArea(Punto1, Punto2, Punto3, Punto4);
    }
    ...
    private Punto ObtenerPunto(int indice)
    {
        return indice switch
        {
            ...
            3 => Punto3,
            4 => Punto4,
            _ => throw new ArgumentException("El índice debe ser 1, 2, 3 o 4")
        };
    }

    public override string ToString()
    {
        return $"Rectángulo: P1{Punto1}, P2{Punto2}, P3{Punto3}, P4{Punto4}";
    }
}
